...
func (l *Launch) linkMachine(ctx context.Context, machine *v1alpha5.Machine) (*v1beta1.NodeClaim, error) {
...
func (l *Launch) launchMachine(ctx context.Context, machine *v1alpha5.Machine) (*v1beta1.NodeClaim, error) {
	created, err := l.cloudProvider.Create(ctx, nodeclaimutil.New(machine))
	if err != nil {
		switch {
...
func PopulateMachineDetails(machine *v1alpha5.Machine, retrieved *v1beta1.NodeClaim) {
