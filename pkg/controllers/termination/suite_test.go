...
import (
	...
	terminator2 "github.com/aws/karpenter-core/pkg/controllers/termination/terminator"
...
var _ = BeforeSuite(func() {
	...
	terminationController = termination.NewController(env.Client, cloudProvider, terminator2.NewTerminator(fakeClock, env.Client, evictionQueue), events.NewRecorder(&record.FakeRecorder{}))
})
...
func ExpectNotEnqueuedForEviction(e *terminator2.EvictionQueue, pods ...*v1.Pod) {
