...
func (p *NodePool) SupportedVerbs() []admissionregistrationv1.OperationType {
...
func (p *NodePool) Validate(ctx context.Context) (errs *apis.FieldError) {
	return errs.Also(
...
func (s *NodePoolSpec) validate(_ context.Context) (errs *apis.FieldError) {
	return errs.Also(
...
//	}
//
//	func (s *NodePoolSpec) validateTTLSecondsAfterEmpty() (errs *apis.FieldError) {
...
//
//	func (s *NodePoolSpec) Validate(ctx context.Context) (errs *apis.FieldError) {
//		return errs.Also(
//			s.validateProvider(),
//			s.validateLabels(),
//			s.validateTaints(),
...
//	}
//
//	func (s *NodePoolSpec) validateLabels() (errs *apis.FieldError) {
//		for key, value := range s.GetLabels {
...
//	}
//
//	func (s *NodePoolSpec) validateTaints() (errs *apis.FieldError) {
...
// // NodePool requirements only support well known labels.
//
...
//	}
//
//	func (s *NodePoolSpec) validateKubeletConfiguration() (errs *apis.FieldError) {
